                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        <Link to="/" className="inline-flex items-center gap-3 mb-6 group">
                            <img src="/logo-256.png" alt="Sri Srinivasa Canvassing Logo" width="56" height="48" className="h-12 w-auto object-contain rounded-lg bg-white p-1 transition-transform group-hover:scale-105 border border-border" loading="lazy" decoding="async" />
